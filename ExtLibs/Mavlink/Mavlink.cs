...
{
    public const string MAVLINK_BUILD_DATE = "Fri Apr 17 2020";
    ...
    public static message_info[] MAVLINK_MESSAGE_INFOS = new message_info[] {
        ...
        new message_info(42002, "IED_STATUS", 217, 4, 4, typeof( mavlink_ied_status_t )),
    ...
    [StructLayout(LayoutKind.Sequential,Pack=1,Size=4)]
    ///<summary> Status of the IED Sensor. </summary>
    public struct mavlink_ied_status_t
    {
        public mavlink_ied_status_t(float voltage) 
        {
              this.voltage = voltage;
            
        }
        /// <summary>Voltage.  [V] </summary>
        [Units("[V]")]
        [Description("Voltage.")]
        public  float voltage;
