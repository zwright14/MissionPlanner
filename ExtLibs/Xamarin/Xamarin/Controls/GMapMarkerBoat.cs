...
namespace MissionPlanner.Maps
{
    ...
    public class GMapMarkerBoat : GMapMarker
    {
        static readonly System.Drawing.Size SizeSt =
            new System.Drawing.Size(Resources.boat.ToBitmap().Width,
                Resources.boat.ToBitmap().Height);
        ...
        public override void OnRender(IGraphics g)
        {
            ...
            g.DrawImageUnscaled(Resources.boat.ToBitmap(),
                Resources.boat.ToBitmap().Width / -2,
                Resources.boat.ToBitmap().Height / -2);
