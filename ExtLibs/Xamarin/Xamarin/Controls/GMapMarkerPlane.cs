...
namespace MissionPlanner.Maps
{
    ...
    {
        private readonly Bitmap icon = Resources.planeicon.ToBitmap();

        private readonly Bitmap icon1 = Resources.planeicon1.ToBitmap();
        private readonly Bitmap icon2 = Resources.planeicon2.ToBitmap();
        private readonly Bitmap icon3 = Resources.planeicon3.ToBitmap();
        private readonly Bitmap icon4 = Resources.planeicon4.ToBitmap();
        private readonly Bitmap icon5 = Resources.planeicon5.ToBitmap();
        private readonly Bitmap icon6 = Resources.planeicon6.ToBitmap();
