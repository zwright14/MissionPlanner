...
namespace MissionPlanner.GCSViews
{
    public partial class FlightPlanner : MyUserControl, IDeactivate, IActivate
    {
        ...
        public FlightPlanner()
        {
            ...
            Commands.Columns[Up.Index].CellTemplate.Value = Resources.up.ToBitmap();
            Commands.Columns[Down.Index].CellTemplate.Value = Resources.down.ToBitmap();

          //  Up.Image = Resources.up.ToBitmap();
          //  Down.Image = Resources.down.ToBitmap();
