...
namespace Xamarin
{
    public partial class FlightPlanner : ContentPage
    {
        ...
        public FlightPlanner()
        {
            ...
            track = new MissionPlanner.GCSViews.FlightPlanner();
            ...
            ((MissionPlanner.GCSViews.FlightPlanner)track).MainMap.MapProvider = GMapProviders.BingSatelliteMap;
        ...
        private void SKGLView_OnPaintSurface(object sender, SKPaintGLSurfaceEventArgs e)
        {
...

            {
              ...
              if (track.Size.Width != (int) SkglView.CanvasSize.Width ||
                  track.Size.Height != (int) SkglView.CanvasSize.Height)
                  track.Size =
                      new System.Drawing.Size((int) SkglView.CanvasSize.Width, (int) SkglView.CanvasSize.Height);
